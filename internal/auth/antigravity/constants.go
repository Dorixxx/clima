...
var (
	ClientID     = firstNonEmptyEnv("ANTIGRAVITY_OAUTH_CLIENT_ID", "GOOGLE_OAUTH_CLIENT_ID")
	ClientSecret = firstNonEmptyEnv("ANTIGRAVITY_OAUTH_CLIENT_SECRET", "GOOGLE_OAUTH_CLIENT_SECRET")
)
