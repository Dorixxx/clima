...
// StartBackgroundServices starts long-lived helpers owned by the server.
...
// StopBackgroundServices stops long-lived helpers owned by the server.
...
func NewServer(cfg *config.Config, authManager *auth.Manager, accessManager *sdkaccess.Manager, configFilePath string, opts ...ServerOption) *Server {
	...
	s.checker = healthcheck.New(cfg, authManager)
	...
	s.mgmt.SetHealthChecker(s.checker)
...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/health-check", s.mgmt.GetHealthCheck)
		mgmt.POST("/health-check/run", s.mgmt.RunHealthCheck)
		mgmt.POST("/health-check/stop", s.mgmt.StopHealthCheck)
		mgmt.GET("/health-check/enabled", s.mgmt.GetHealthCheckEnabled)
		mgmt.PUT("/health-check/enabled", s.mgmt.PutHealthCheckEnabled)
		mgmt.PATCH("/health-check/enabled", s.mgmt.PutHealthCheckEnabled)
		mgmt.GET("/health-check/interval", s.mgmt.GetHealthCheckInterval)
		mgmt.PUT("/health-check/interval", s.mgmt.PutHealthCheckInterval)
		mgmt.PATCH("/health-check/interval", s.mgmt.PutHealthCheckInterval)
		mgmt.GET("/health-check/parallelism", s.mgmt.GetHealthCheckParallelism)
		mgmt.PUT("/health-check/parallelism", s.mgmt.PutHealthCheckParallelism)
		mgmt.PATCH("/health-check/parallelism", s.mgmt.PutHealthCheckParallelism)
		mgmt.GET("/health-check/unauthorized-action", s.mgmt.GetHealthCheckUnauthorizedAction)
		mgmt.PUT("/health-check/unauthorized-action", s.mgmt.PutHealthCheckUnauthorizedAction)
		mgmt.PATCH("/health-check/unauthorized-action", s.mgmt.PutHealthCheckUnauthorizedAction)
		mgmt.GET("/health-check/zero-quota-action", s.mgmt.GetHealthCheckZeroQuotaAction)
		mgmt.PUT("/health-check/zero-quota-action", s.mgmt.PutHealthCheckZeroQuotaAction)
		mgmt.PATCH("/health-check/zero-quota-action", s.mgmt.PutHealthCheckZeroQuotaAction)
		mgmt.GET("/health-check/provider-policies", s.mgmt.GetHealthCheckProviderPolicies)
		mgmt.PUT("/health-check/provider-policies", s.mgmt.PutHealthCheckProviderPolicies)
		mgmt.PATCH("/health-check/provider-policies", s.mgmt.PutHealthCheckProviderPolicies)
...
func (s *Server) UpdateClients(cfg *config.Config) {
	...
	if s.checker != nil {
		...
		s.checker.SetAuthManager(s.handlers.AuthManager)
	}
