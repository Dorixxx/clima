...
var (
	geminiOAuthClientID     = firstNonEmptyEnv("GEMINI_OAUTH_CLIENT_ID", "GOOGLE_OAUTH_CLIENT_ID")
	geminiOAuthClientSecret = firstNonEmptyEnv("GEMINI_OAUTH_CLIENT_SECRET", "GOOGLE_OAUTH_CLIENT_SECRET")
)
...
var (
	antigravityOAuthClientID     = firstNonEmptyEnv("ANTIGRAVITY_OAUTH_CLIENT_ID", "GOOGLE_OAUTH_CLIENT_ID")
	antigravityOAuthClientSecret = firstNonEmptyEnv("ANTIGRAVITY_OAUTH_CLIENT_SECRET", "GOOGLE_OAUTH_CLIENT_SECRET")
)
