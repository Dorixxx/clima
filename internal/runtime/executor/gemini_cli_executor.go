...
var (
	geminiOAuthClientID     = firstNonEmptyExecutorEnv("GEMINI_OAUTH_CLIENT_ID", "GOOGLE_OAUTH_CLIENT_ID")
	geminiOAuthClientSecret = firstNonEmptyExecutorEnv("GEMINI_OAUTH_CLIENT_SECRET", "GOOGLE_OAUTH_CLIENT_SECRET")
)
...
func firstNonEmptyExecutorEnv(keys ...string) string {
