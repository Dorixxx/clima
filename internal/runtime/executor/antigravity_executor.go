...
var (
	antigravityClientID     = firstNonEmptyExecutorEnv("ANTIGRAVITY_OAUTH_CLIENT_ID", "GOOGLE_OAUTH_CLIENT_ID")
	antigravityClientSecret = firstNonEmptyExecutorEnv("ANTIGRAVITY_OAUTH_CLIENT_SECRET", "GOOGLE_OAUTH_CLIENT_SECRET")
